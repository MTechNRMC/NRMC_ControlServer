...
LD = g++
LDFLAGS = 
LIBS = NetworkLib/NRMCNetworkLib.a NetworkLib/SocketLib/SocketLib.a MCS_Lib/NRMC_MCSLib.a HardwareLib/NRMCHardwareLib.a HardwareLib/RPLidarLib/librplidar_sdk.a
OBJS = 
TSTOBJS = 
ARLIB = 
EXEC = ControlServer
